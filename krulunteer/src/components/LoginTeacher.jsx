        ...
        <div className="w-full flex flex-col items-center justify-start mt-[30%]">
            ...
            <div className="w-[80%] mt-7 mb-5">
                ...
                <div className="relative flex items-center w-full bg-white border border-gray-300 rounded-2xl px-4 py-2 focus-within:border-green-800">
                    ...
                    <input id="id-card" type="text" placeholder="เช่น 1-1000-00000-00-0" className="w-full pl-10 outline-none text-gray-700 text-[1.2rem]" />
                </div>
            </div>
            <button className="w-[80%] bg-[#368C64] text-white py-3 rounded-2xl text-[1.2rem] cursor-pointer hover:bg-green-800 transition-colors">Verify & Login with ID Number</button>
